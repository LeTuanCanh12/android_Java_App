...
public class ChatActivity extends AppCompatActivity {
    ...
    private void insertUser() {
        ...
        user.put("id",Utils.user_current.getIdChat());
        user.put("username",Utils.user_current.getUsername());
        db.collection("users").document(String.valueOf(Utils.user_current.getIdChat()))
                .set(user);
    }
    ...
    private void sendMessToFire() {
        ...
        if (TextUtils.isEmpty(str_mess)) {
            ...
            message.put(Utils.SENDID, String.valueOf(Utils.user_current.getIdChat()));
    ...
    private void listenMess(){
        db.collection(Utils.PATH_CHAT)
                .whereEqualTo(Utils.SENDID, String.valueOf(Utils.user_current.getIdChat()))
                .whereEqualTo(Utils.RECEIVEDID,Utils.ID_RECEIVED)
                .addSnapshotListener(eventListener);
        db.collection(Utils.PATH_CHAT)
                .whereEqualTo(Utils.SENDID,Utils.ID_RECEIVED )
                .whereEqualTo(Utils.RECEIVEDID, String.valueOf(Utils.user_current.getIdChat()))
                .addSnapshotListener(eventListener);
    ...
    private void initView() {
        ...
        adapter = new ChatAdapter(getApplicationContext(),list,String.valueOf(Utils.user_current.getIdChat()));
