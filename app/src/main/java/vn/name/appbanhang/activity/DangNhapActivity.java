...
public class DangNhapActivity extends AppCompatActivity {
    ...
    private void dangNhap(String email, String pass){
        ...
        firebaseAuth.signInWithEmailAndPassword(email,pass).addOnCompleteListener(DangNhapActivity.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if(task.isSuccessful()){
                                    Toast.makeText(getApplicationContext(), "Đăng nhập thành công", Toast.LENGTH_SHORT).show();
                                                            ...
                                                            Paper.book().write("valueUser",true);
                                                            Utils.user_current.setIdChat(FirebaseAuth.getInstance().getCurrentUser().getUid());
                                                            Intent intent = new Intent(getApplicationContext(), MainActivity.class);
                                                            startActivity(intent);
                                                            finish();
                                }
                                else{
                                    Toast.makeText(getApplicationContext(), "Kiểm tra lại thông tin đăng nhập", Toast.LENGTH_SHORT).show();
                                }
